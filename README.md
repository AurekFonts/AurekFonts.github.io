...
#### Examples
![Domabesh_Console example image: "I am one with the Force; the Force is with me."](https://github.com/AurekFonts/Domabesh_Console/blob/master/IAmOne.png?raw=true "Example: 'I am one with the Force; the Force is with me'")
#### Characters
